...
export default function SignUp() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#0A0A0A', padding: 24, gap: 12, paddingTop: 80 }}>
      <Text style={{ color: '#00F0FF', fontSize: 28, fontWeight: '700' }}>Create account</Text>
      ...
      <Pressable onPress={submit} style={{ backgroundColor: 'transparent', borderColor: '#1DD1A1', borderWidth: 1, borderRadius: 12, padding: 12, alignItems: 'center' }}>
        <Text style={{ color: '#1DD1A1' }}>Sign up</Text>
      </Pressable>
      <Link href="/(auth)/sign-in" style={{ color: '#00F0FF', marginTop: 12 }}>Already have an account? Sign in</Link>
    </View>
  );
}
